    ...
    <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
      ...
      <div className="h-1/2 lg:h-full lg:w-1/2 flex flex-col justify-center gap-8">
        ...
        <div className="flex gap-8 py-4">
          <button className="p-4 rounded-lg ring-1 ring-black bg-black text-white relative"> View My Work </button>
          <button className="p-4 rounded-lg ring-1 ring-black bg-white text-black relative"> Contact Me </button>
        </div>
      </div>
      {/* ------------------- Image Section --------------- */}
